...
public class insertarConsola extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        Consola consola = new Consola(0, nombre, compania, potenciaCPU, potenciaGPU, precio, unidades, generacion);
        ...
        try {
            ...
            if (conexion.insertarConsola(consola)) {
                out.println("<form>");
                out.println("<h2>Consola añadida correctamente</h2>");
                out.println("<a href='menuAdmin.jsp'>Volver al menú principal</a>");
                out.println("</form>");
            } else {
                out.println("<form>");
                out.println("<h2>Fallo al añadir la consola</h2>");
                out.println("<a href='menuAdmin.jsp'>Volver al menú principal</a>");
                out.println("</form>");
            }
            ...
            out.println("<body>");
            out.println("<form>");
            out.println("<h2>Error al insertar la consola</h2>");
    ...
    public String getServletInfo() {
        return "Servlet para insertar consolas con estilos CSS integrados";
    }
}
