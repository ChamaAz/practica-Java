...
public class consolaAeliminar extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            conexion.eliminarConsola(consola);
            out.println("<h2>Consola eliminada</h2>");
            out.print("<a href='menuAdmin.jsp'>Menú principal</a>");
            out.print("<br>");
            out.print("<a href='eliminarConsola'>Volver</a>");
            out.print("<br><br>");
        } catch (Exception e) {
            out.println("<h2 class='error'>Error al eliminar la consola</h2>");
